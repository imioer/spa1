...
Neoslobađanje memorije nakon završetka korišćenja može dovesti do curenja memorije. Kako bi mogli da dinamički alociramo memoriju u C-u neophodno je da učitamo biblioteku `stdlib.h`.
